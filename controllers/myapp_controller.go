...
import (
	...
	mydomainv1alpha1 "k8s-operator/api/v1alpha1"
...
//+kubebuilder:rbac:groups=my.domain,resources=myapps,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=my.domain,resources=myapps/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=my.domain,resources=myapps/finalizers,verbs=update
